...
$update = $pdo->prepare("UPDATE tb_check 
...
if($update->execute())
  {
    update_check_status($pdo,$checkstatusid,$timestamp,$checkid);
        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                    <h5 class="m-0 text-white" ><a href="bank_check_menu.php" class="text-white">View Checks</a> / Edit Check</h5>
                </div>
                <!-- card body open --> 
                    ...
                    <div class="col-md-6">
                        <li class="list-group-item">
                          ...
                          <div class="form-group">
                              <select class="form-control select2" data-dropdown-css-class="select2-purple" name="bankid" required>
                          ...
                          <div class="form-group">
                              <select class="form-control select2" data-dropdown-css-class="select2-purple" name="payeeid" required>
                        ...
                        <li class="list-group-item"><b>Check status : </b>&emsp;
                ...
                <div class="card-footer">
                  <div class="text-center">
                      <button type="submit" class="btn btn-primary btn-md" name="updatecheck">Update Check</button>
                  </div>
                </div>
                <!-- card footer close --> 
