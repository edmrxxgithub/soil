  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Add Data Menu</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

<form method="post" id="confirm_add_supplier_data">      
        ...
        <div class="row">
          ...
          <div class="col-md-6">
                <li class="list-group-item">
                  <input type="hidden" id="payableid_hidden" name="payableid_hidden">
                  <div class="form-group">
                      <b>Supplier name : </b>&emsp;
                      <input type="text" disabled class="form-control" id="supplier_name"  >
                  </div>
                  <div class="form-group">
                      <b>Address : </b>&emsp;
                      <input type="text" disabled class="form-control" id="supplier_address"  >
                  </div>
                  <div class="form-group">
                      <b>Contact Num : </b>&emsp;
                      <input type="text" disabled class="form-control" id="supplier_contact_num"  >
                  </div>
                  <div class="form-group">
                      <b>TIN : </b>&emsp;
                      <input type="text" disabled class="form-control" id="supplier_tin"  >
                  </div>
                  <div class="form-group">
                      <b>CODE : </b>&emsp;
                      <input type="text" disabled class="form-control" id="supplier_code"  >
                  </div>
                </li>
          </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                  <h5 class="m-0 text-white">View Payable Suppliers</h5>
                </div>
                <div class="card-body">
                  <div class="row">
                    
                    <div class="col-sm-12">
                        <a href="accounts_payables_add_supplier.php" class="btn btn-md btn-primary float-sm-right">Add supplier</a>
                    </div>
        
      <div class="col-md-12 mt-3">
            <div class="table-responsive-sm">
              <font face="verdana">
                <table id="account_payable_supplier_datatable" class="table table-hover" style="width: 100%">
                    <thead>
                        <tr>
                            <td style="font-weight: bold;" align="center">Id</td> 
                            <td style="font-weight: bold;" align="center">Name</td> 
                            <td style="font-weight: bold;" align="center">Supplier code</td> 
                            <td style="font-weight: bold;" align="center">Gross purchase</td> 
                            <td style="font-weight: bold;" align="center">Total payment</td> 
...
<script>
  $(document).ready(function() 
  {
    ...
    var account_payable_supplier_datatable = $('#account_payable_supplier_datatable').DataTable(
    {
      "order": [[ 0, 'desc' ]],
...
$(document).on('keyup','#supplier_price',function()
{
    ...
    $(document).on('click','#accounts_payables_delete_data',function()
    {
