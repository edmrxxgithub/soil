...
<div class="card card-default collapsed-card">    
    ...
    <h3 class="card-title text-black"  style="font-weight:bold;">IT COMPUTATION QUARTER 2</h3>
...
<table  border="1" width="100%">
  ...
  <!-- <input type="text" id="samplesampletext" name=""> -->
      ...
      <tr align="center">
        ...
        <td align="center" id="#"><?= number_format($quarter2_it_data['grossincome'],2) ?></td>
      </tr>

      <tr align="center">
        <td><font size="2">Cost of sales</font></td>
        <td align="center" id="#"><?= number_format($quarter2_it_data['cost_of_sales'],2) ?></td>
      </tr>

      <tr align="center">
        <td><font size="2">Deductions</font></td>
        <td align="center" id="#"><?= number_format($quarter2_it_data['total_non_vat_purchase'] + $quarter2_it_data['total_vat_purchase'] + $quarter2_it_data['other_expenses_2'],2) ?></td>
      </tr>
      ...
      <tr align="center">
        ...
        <td align="center" id="#"><?= number_format($quarter2_it_data['taxable_income_to_date'],2) ?></td>
      </tr>


     <!--  <tr align="center">
        <td><font size="2">Preferred income tax</font></td>
        <td align="center" id="#"><?= number_format($quarter2_it_data['incometaxdue'],2) ?></td>
      </tr> -->
