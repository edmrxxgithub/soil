...
$quarter1_data = fetch_data($pdo,7,9,3,$yearnow,$branchid);
    ...
    <?php include_once 'tax_return_q1/tax_fetch_data10.php'?>
      ...
      <div class="col-sm-12 col-md-12 col-lg-12">
        <center>
            ...
            <button class="btn btn-md btn-success mt-3" id="btn_edit_all_data_quarter3">Edit data</button>
        </center>
      </div>
...
<!-- ///////////// QUARTER 1 TAX RETURN  /////////// -->
 ...
 <script type="text/javascript">
  $(document).ready(function()
  {
        ...
        $(document).on('click','#btn_edit_all_data_quarter3',function()
        {

            window.location.href = "tax_view_quarter_all_data.php?quarter=3&yearnow="+year_now+'&branchid='+branch_id+'&monthfrom=7&monthto=9';
