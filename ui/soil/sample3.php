...
<table  border="1" width="100%">
            ...
            <tr align="center">
              ...
              <td style="font-weight:bold;">NATURE OF INCOME PAYMENT</td>
              <td style="font-weight:bold;">TAX BASED</td>
            ...
            <?php
              ...
              $janselect = $pdo->prepare("SELECT * FROM tb_tax_supplier ");
              $janselect->execute();
              while($rowjanselect = $janselect->fetch(PDO::FETCH_OBJ))
              {

                $tax_supplier_id = $rowjanselect->id;
                $tax_supplier_name = $rowjanselect->name;

            ?>
            
            <tr align="center">
              <td><font size="2"><?= $tax_supplier_id ?></font></td>
              <td><font size="2"><?= $tax_supplier_name ?></font></td>
