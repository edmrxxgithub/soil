...
$government_sales = $_POST['q1_government_sales_principal'];
$zero_rated_sales = $_POST['q1_zero_rated_sales_principal'];
$exempt_sales = $_POST['q1_exempt_sales_principal'];

$other_expenses = $_POST['q1_other_expense_principal'];
$vat_payment_previous = $_POST['q1_vat_payment_previous_principal'];
$tax_actually_paid_success = $_POST['q1_tax_actual_paid_accessory'];

$cost_of_sales = $_POST['q1_less_cost_of_sales_accessory'];
$tax_income_previous = $_POST['q1_net_taxable_income_previous_quarter_accessory'];
$other_expenses_2 = $_POST['q1_other_expenses_value_principal_2'];

$tax_rate = $_POST['q1_tax_rate_principal'];
$mcit = $_POST['q1_mcit_percent_principal'];
$it_payment_previous = $_POST['q1_it_payment_previous_principal'];
$income_tax_actually_paid_success = $_POST['q1_income_tax_actually_paid_accessory'];
