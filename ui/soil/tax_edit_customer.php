        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                    <h5 class="m-0 text-white" ><a href="tax_customer.php" class="text-white">View Customer</a> / Edit Customer</h5>
                </div>
                <!-- card body open --> 
...
if (isset($_POST['update_customer'])) 
{
  ...
  $customer_id = $_POST['customeridhidden'];
  ...
  $address = $_POST['address'];
    ...
    $update = $pdo->prepare("UPDATE tb_tax_customer SET name = '$name', tin = '$tin', address = '$address' WHERE id = '$customer_id' ");
...
?>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <input type="hidden" name="customeridhidden" value="<?= $customerid ?>">

                    <div class="col-md-6">
                        <li class="list-group-item">
                          <div class="form-group">
                              <b>Client name : </b>&emsp;
                              <input type="text" class="form-control" autocomplete="off" name="customername" placeholder="Input supplier name" required="" value="<?= $row->name ?>" >
                          </div>
                          <div class="form-group">
                              <b>TIN : </b>&emsp;
