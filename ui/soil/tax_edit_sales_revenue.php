...
$selectmain = $pdo->prepare("SELECT * FROM tb_tax_sales WHERE id = '$salesrevenueid_php' ");
$selectmain->execute();
...
if (isset($_POST['updatesalesrevenue'])) 
{

$salesrevenue_id = $_POST['salesrevenueid'];
...
WHERE id = '$salesrevenue_id' ");

    if ($update->execute()) 
    {
      $_SESSION['status']="Sales revenue update success!";
      $_SESSION['status_code']="success";
    }
    else
    {
      $_SESSION['status']="Sales revenue update failed!";
            ...
            <div class="card card-grey card-outline">
                ...
                <div class="card-footer">
                  <div class="text-center">
                      <button type="submit" class="btn btn-primary btn-md" name="updatesalesrevenue">Update Sales Revenue</button>
                  </div>
                </div>
                <!-- card footer close --> 
