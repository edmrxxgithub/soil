...
{
  $select = $pdo->prepare("SELECT SUM(total) as total_gross_purchase FROM tb_account_supplier_data where account_supplier_id = '$id' ");
  $select->execute();
...
{
  $select = $pdo->prepare("SELECT SUM(amount) as total_paid FROM tb_account_supplier_payment where account_supplier_id = '$id' ");
  $select->execute();
  $row = $select->fetch(PDO::FETCH_OBJ);
...
$select = $pdo->prepare("SELECT * FROM tb_account_supplier where id = '$supplier_id' ");
$select->execute();
$row = $select->fetch(PDO::FETCH_OBJ);

$gross_purchase = fetch_gross_purchase($pdo,$supplier_id);
...
<input type="hidden" id="supplier_id_hidden" value="<?= $supplier_id ?>">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                    <h5 class="m-0 text-white" ><a href="accounts_payables.php" class="text-white">View Payable Suppliers</a> / <?= $row->name ?></h5>
                </div>
                <!-- card body open --> 
                <div class="card-body">
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="small-box bg-white" >
                          <div class="inner" style="background-color:rgba(50,63,81,255);">
                            <h3 class="text-white"><?= number_format($gross_purchase,2) ?></h3>
                            <p class="text-white">GROSS PURCHASE</p>
                          </div>
                          <div class="icon">
      ...
      <div class="card-body">
        <div class="col-sm-12 col-lg-12">
          <div class="row">
            ...
            <div class="col-sm-12">
                <a href="accounts_insert_supplier_data.php?id=<?= $supplier_id ?>" class="btn btn-md btn-primary float-sm-right"><span class="fa fa-plus"  data-toggle="tooltip" title="View Category" ></span>&nbsp;&nbsp;Add Data</a>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 mt-3">
                ...
                <div class="table-responsive-sm">
                  <font face="verdana">
                    <table id="accounts_payable_datatable" class="table table-hover" style="width: 100%">
                        <thead>
                            <tr>
...
unset($_SESSION['status']);
  ...
  <script type="text/javascript">
    ...
    var accounts_payable_datatable = $('#accounts_payable_datatable').DataTable(
    {
      "order": [[ 0, 'desc' ]],
    ...
    "iDisplayLength": 10,
        ...
        "ajax": 
        {
          ...
          url:"accounts_fetch_payables_data.php?supplier_id="+supplier_id,
          type:"post"
        } ,
...
``
    ...
    $(document).on('click','#view_payables',function()
    {
      ...
      // alert(id);
      // alert('God is good, life is good! 8778');
