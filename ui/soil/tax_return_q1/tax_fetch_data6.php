        ...
        <td>
          <font size="2">
            <input type="text" style="width: 100%; text-align: center; box-sizing: border-box;"  
                value="<?= number_format($quarter1_data['cost_of_sales'],2) ?>" disabled id="q1_less_cost_of_sales_accessory">
          </font>
        </td>
      </tr>
    ...
    <tr>
        ...
        <td>
            <font size="2">
                <input style="width:100%;text-align: center;" type="text" value="<?= number_format($quarter1_data['other_expenses_2'],2) ?>" disabled id="q1_other_expenses_value_principal_2">
            </font>
        </td>
        <td>
          <font size="2">
