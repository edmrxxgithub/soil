    <tr>
        ...
        <td align="center">
            <font size="2">
                ...
                value="" id="q3_value_added_tax_payable_principal">
            </font>
        </td>
        ...
        <td align="center">
          <font size="2" id="">
            <input type="text" style="width: 100%; text-align: center; box-sizing: border-box;" disabled 
                value="<?= number_format($data_rr['total_swt_vt'],2) ?>" id="q3_value_added_tax_payable_accessory">
          </font>
        </td>
      </tr>
        ...
        <td>
          <font size="2">
            <input type="text" style="width: 100%; text-align: center; box-sizing: border-box;"  
                value="0"  id="q3_tax_actual_paid_accessory">
          </font>
        </td>
      </tr>
