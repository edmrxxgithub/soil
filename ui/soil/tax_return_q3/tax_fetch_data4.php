    <tr>
        ...
        <td align="center">
            <font size="2">
                ...
                value="" id="q3_value_added_tax_due_principal">
            </font>
        </td>
        ...
        <td align="center">
          <font size="2" id="">
            <input type="text" style="width: 100%; text-align: center; box-sizing: border-box;" disabled 
                value="" id="q3_value_added_tax_due_accessory">
          </font>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
            <font size="2">
                <input style="width:100%;text-align: center;" type="text" value="" disabled id="q3_tax_credits_principal">
            </font>
        </td>
        <td>
          <font size="2">
            <input type="text" style="width: 100%; text-align: center; box-sizing: border-box;" disabled 
                value=""  id="q3_tax_credits_accessory">
          </font>
        </td>
      </tr>
    ...
    <tr>
        ...
        <td align="center">
            <font size="2">
                ...
                value="0" id="q3_vat_payment_previous_principal">
            </font>
        </td>
      ...
      <tr>
        ...
        <td>
            <font size="2">
                <input style="width:100%;text-align: center;" type="text" value="<?= number_format($data_rr['total_swt_vt'],2) ?>" disabled id="q3_vat_withheld_government_principal">
            </font>
        </td>
        <td>
          <font size="2">
            <input type="text" style="width: 100%; text-align: center; box-sizing: border-box;" disabled 
                value="<?= number_format($data_rr['total_swt_vt'],2) ?>"  id="q3_vat_withheld_government_accessory">
          </font>
        </td>
      </tr>
