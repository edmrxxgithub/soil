...
function fetch_business_id($pdo,$id)
{
...
$branchid = $_GET['id'];
$businessid = fetch_business_id($pdo,$branchid);
...
$insert = $pdo->prepare("UPDATE tb_tax_branch SET client_id = '$clientid', business_id = '$businessid', tin = '$tin', address = '$address' WHERE id = '$branchid' ");
        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                    ...
                    <a href="tax_view_client_business.php?id=<?= $businessid ?>" class="text-white"><?= $data['businessname'] ?></a> / Edit branch
                  </h5>
                </div>
                <!-- card body open --> 
                ...
                <div class="card-footer">
                  <div class="text-center">
                      <button type="submit" class="btn btn-primary btn-md" name="updatebranch">Update Branch</button>
                  </div>
                </div>
                <!-- card footer close --> 
