...
$select = $pdo->prepare("SELECT * FROM tb_account_customer where id = '$id' ");
$select->execute();
...
if (isset($_POST['add_customer_data'])) 
{
    

$id = $_POST['customer_id_hidden'];
...
$pdo->prepare("INSERT INTO tb_account_customer_data SET

account_customer_id  = '$id' , 
date = '$date' , 
...
status  = '0' ");
  ...
  if ($insert->execute()) 
  {
    $_SESSION['status']="Customer data created successfully!";
    $_SESSION['status_code']="success";
  }
  else
  {
    $_SESSION['status']="Customer data created failed!";
...
?>
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                    <h5 class="m-0 text-white" ><a href="accounts_receivables.php" class="text-white">View Receivable Customers</a> / <a href="accounts_receivables_view_customer.php?id=<?= $id ?>" class="text-white"><?= $row->name ?></a> / Add data</h5>
                </div>
                <!-- card body open --> 
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        <li class="list-group-item">
                          ...
                          <input type="hidden" value="<?= $id ?>" name="customer_id_hidden" >
                ...
                <div class="card-footer">
                  <div class="text-center">
                      <button type="submit" class="btn btn-primary btn-md" name="add_customer_data">Add Data</button>
                  </div>
                </div>
                <!-- card footer close --> 
