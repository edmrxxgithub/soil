        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                    <h5 class="m-0 text-white" ><a href="accounts_receivables.php" class="text-white">View Receivable Customers</a> / Add Customer</h5>
                </div>
                <!-- card body open --> 
...
// name  address contact_num tin
  ...
  {
    $_SESSION['status']="Customer created failed!";
...
?>
                ...
                <div class="card-footer">
                  <div class="text-center">
                      <button type="submit" class="btn btn-primary btn-md" name="add_customer">Add Customer</button>
                  </div>
                </div>
                <!-- card footer close --> 
