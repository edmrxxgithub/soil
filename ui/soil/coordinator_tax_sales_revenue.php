...
function fill_customer($pdo)
{
    ...
    $output='';
    $select=$pdo->prepare("SELECT * FROM tb_tax_customer order by id asc");
    $select->execute();
    $result=$select->fetchAll();
    foreach($result as $row)
    {
        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                    <h5 class="m-0 text-white" ><a href="dashboard_coordinator.php" class="text-white">Coordinator Dashboard</a> / Add Sales Revenue</h5>
                </div>
                <!-- card body open --> 
...
if (isset($_POST['addsalesrevenue'])) 
{


$customerdataf = fetch_customer_data($pdo,$_POST['customerid']);
...
// echo $clientid.' '.$businessid.' '.$branchid.' '.$customerid;
                    ...
                    <div class="col-md-6">
                        <li class="list-group-item">
                          <input type="hidden" value="soil123" name="defaultpassword" >
                            ...
                            <div class="form-group mt-3">
                              <b>TIN : </b>
                              <input type="text" autocomplete="off" class="form-control" id="tin"  required="" disabled placeholder="Input TIN">
                            </div>
                            <div class="form-group mt-3">
                              <b>Address : </b>
                              <input type="text" autocomplete="off" class="form-control" id="address" required="" disabled placeholder="Input address">
                            </div>
                            <div class="form-group mt-3">
                              <b>Order status : </b>
                              <input type="text" autocomplete="off" class="form-control" name="order_status" required="" placeholder="Input order status" value="Completed">
                            </div>
                            <div class="form-group mt-3">
                              <b>Payment method : </b>
                              <input type="text" autocomplete="off" class="form-control" name="payment_method" required="" placeholder="Input payment method" value="Cash">
                            </div>
                            <div class="form-group mt-3">
                              <b>Description : </b>
                              <input type="text" autocomplete="off" class="form-control" id="description"  required="" disabled placeholder="Input description" value="Various customer sales">
                            </div>
                            <div class="form-group mt-3">
                              <b>Invoice No. : </b>
            ...
            <div class="row">
                ...
                <div class="card-footer">
                  <div class="text-center">
                      <button type="submit" class="btn btn-primary btn-md" name="addsalesrevenue">Add Sales Revenue</button>
                  </div>
                </div>
                <!-- card footer close --> 
