                    ...
                    <div class="col-md-6">
                        <li class="list-group-item">
                          <input type="hidden" value="<?= $sales_id ?>" name="sales_id_hidden" >
                            ...
                            <div class="form-group mt-3">
                              <b>Total vat : </b>
                              <input type="text" disabled class="form-control" id="total_vat_amount" name="total_vat_amount" value="<?= $rowmain->vat ?>">
                            </div>

              <div class="form-group mt-3">
                <b>Net of vat : </b>
                <input type="text" disabled class="form-control" id="net_of_vat_amount" name="net_of_vat_amount" value="<?= $net_of_vat ?>">
...
<!-- <div class="col-md-6">
      <li class="list-group-item">
        <input type="hidden" value="soil123" name="defaultpassword" >
          ...
          <div class="form-group mt-3">
            <b>Description : </b>
            <input type="text" autocomplete="off" class="form-control" name="description" required="" placeholder="Input description" value="Various customer sales">
          </div>
          <div class="form-group mt-3">
            <b>Invoice No. : </b>
...
// alert(cwt_percent+' '+net_of_vat_amount_hidden);
