        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                  <h5 class="m-0 text-white">View Non Vat Expense</h5>
                </div>
                <div class="card-body">
                  <div class="row">
                   <!--  <div class="col-sm-3 col-lg-3">
                    ...
                    <div class="col-sm-12">
                        <a href="tax_add_non_vat_purchase.php" class="btn btn-sm btn-primary float-sm-right">Add Non Vat</a>
                        <!-- <button class="btn btn-md btn-warning float-md-right" id="clearfilter">Clear filter</button> -->
                    </div>
        
                    <div class="col-md-12 mt-3">
                          <div class="table-responsive-sm">
                            <font face="verdana">
                              <table id="non_vat_purchase_datatable" class="table table-hover" style="width: 100%">
                                  <thead>
                                      <tr>
...
<script>
  $(document).ready(function() 
  {
    ...
    var non_vat_purchase_datatable = $('#non_vat_purchase_datatable').DataTable(
    {
      "order": [[ 3, 'desc' ]],
    ...
    "ajax": 
        {
          ...
          url:"tax_fetch_non_vat_purchase.php",
          type:"post"
        } ,
...
function reset_filter()
{
    ...
    non_vat_purchase_datatable.columns(1).search('').draw();
    non_vat_purchase_datatable.columns(2).search('').draw();
    non_vat_purchase_datatable.columns(3).search('').draw();
...
$(document).on('change','#clientid',function()
{
  ...
  non_vat_purchase_datatable.columns(1).search(clientid).draw();
...
$(document).on('change','#businessid',function()
{
  ...
  non_vat_purchase_datatable.columns(2).search(businessid).draw();
...
$(document).on('change','#branchid',function()
{
  ...
  non_vat_purchase_datatable.columns(3).search(branchid).draw();
...
$(document).on('click','#btn_delete_non_vat_purchase',function()
    {
      ...
      // alert(id);
          ...
          Swal.fire({
          title: 'Delete NON VAT purchase data?',
            ...
            }).then((result) => 
            {
              if (result.isConfirmed) 
              {
                ...
                $.ajax({
                  ...
                  url: 'tax_delete_non_vat_purchase.php',
                  type: 'post',
                  data:'id='+id,
                  success: function(data) 
                  {
                    $('#non_vat_purchase_datatable').DataTable().ajax.reload(null, false);
                  }
                });

                Swal.fire(
                  'Purchase non vat data deleted!',
                  '',
                  'success'
                )
              }
