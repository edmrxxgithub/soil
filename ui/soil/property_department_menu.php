        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                  <h5 class="m-0 text-white">Property Department</h5>
                </div>
                <div class="card-body">
                  <div class="row">
                    
                    <div class="col-sm-12">
                        <a href="property_department_add.php" class="btn btn-md btn-primary float-sm-right">Add department</a>
                    </div>
        
                    <div class="col-md-12 mt-3">
                          <div class="table-responsive-sm">
                            <font face="verdana">
                              <table id="property_fetch_department" class="table table-hover" style="width: 100%">
                                  <thead>
                                      <tr>
                                          <td style="font-weight: bold;" align="center">Id</td> 
                                          <td style="font-weight: bold;" align="center">Department name</td>   
...
<script>
  $(document).ready(function() 
  {
    ...
    var property_fetch_department = $('#property_fetch_department').DataTable(
    {
      // "order": [[ 0, 'desc' ]],
    ...
    "columnDefs": 
        ...
        "ajax": 
        {
          ...
          url:"property_fetch_department.php",
          type:"post"
        }  
