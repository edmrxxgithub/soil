...
$select=$pdo->prepare("SELECT * FROM tb_tax_vat_purchase where id = '$vat_purchase_id' ");
$select->execute();
...
if (isset($_POST['updatevarpurchase'])) 
{
...
$insert = $pdo->prepare("UPDATE tb_tax_vat_purchase 
SET 
...
if ($insert->execute()) 
  {
    $_SESSION['status']="Vat purchase update success!";
    $_SESSION['status_code']="success";
  }
  else
  {
    $_SESSION['status']="Vat purchase update fail!";
        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                    <h5 class="m-0 text-white" ><a href="tax_vat_purchase.php" class="text-white">View VAT Purchase</a> / Edit VAT Purchase</h5>
                </div>
                <!-- card body open --> 
...
<input type="hidden" name="vatpurchaseid_hidden" value="<?= $rowmain->id ?>" >
                    ...
                    <div class="col-md-6">
                        <li class="list-group-item">
                            ...
                            <div class="form-group mt-3">
                                <select class="form-control select2" disabled data-dropdown-css-class="select2-purple" style="width: 100%;" required="" name="supplierid" id="supplierid">
                            ...
                            <div class="form-group mt-3">
                              <b>Date : </b>
                              <input type="date" class="form-control" disabled name="date" required="" value="<?= $rowmain->date ?>" >
                            </div>
                            ...
                            <div class="form-group mt-3">
                              ...
                              <input type="text" autocomplete="off" disabled class="form-control" name="exp_classification" required="" placeholder="Input expenditure classification" id="exp_classification" value="<?= $rowmain->exp_class ?>" >
                            </div>
                            <div class="form-group mt-3">
                              <b>Expense Type : </b>
                              <input type="text" autocomplete="off" disabled class="form-control" name="exp_type" required="" placeholder="Input expense type" id="exp_type" value="<?= $rowmain->exp_type ?>">
                            </div>
                            <div class="form-group mt-3">
                              <b>Reference No. : </b>
                              <input type="text" autocomplete="off" disabled class="form-control" name="reference_num" required="" placeholder="Input reference num" id="reference_num" value="<?= $rowmain->reference_num ?>">
                            </div>
                            
                            <div class="form-group mt-3">
                              <b>Gross Amount : </b>
                              <input type="text" autocomplete="off" disabled class="form-control" name="gross_amount" required="" placeholder="Input gross amount" id="gross_amount" value="<?= $rowmain->gross_amount ?>">
                            </div>
                            <div class="form-group mt-3">
                              <b>12% VAT : </b>
                ...
                <div class="card-footer">
                  <!-- <div class="text-center">
                      <button type="submit" class="btn btn-primary btn-md" name="updatevarpurchase">Update Vat purchase</button>
                  </div> -->
                </div>
                <!-- card footer close --> 
