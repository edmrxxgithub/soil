    ...
    <tr>
        ...
        <td align="center">
            <font size="2">
                <input type="text" style="width: 100%; text-align: center; box-sizing: border-box;"  
                value="0"  id="q2_it_payment_previous_principal">
            </font>
        </td>
    ...
    <tr>
        ...
        <td align="center">
            <font size="2">
                <input type="text" style="width: 100%; text-align: center; box-sizing: border-box;"  
                value="<?= number_format($data_rr['total_swt_it'],2) ?>" disabled id="q2_it_withheld_cwt_principal">
            </font>
        </td>
        ...
        <td align="center">
          <font size="2" id="">
            <input type="text" style="width: 100%; text-align: center; box-sizing: border-box;"  
                value="" disabled id="q2_it_withheld_cwt_accessory">
          </font>
        </td>
    </tr>
