...
<table  border="1" width="100%">
            <tr align="center">
              <th colspan="9" style="background-color:rgba(12,25,60,255);">
                <font class="text-white">SAWT DATA <?= $yearnow ?></font>
              </th>
            </tr>
            
            <tr align="center">
              <td style="font-weight:bold;">Seq No.</td>
              <td style="font-weight:bold;">TIN</td>
              <td style="font-weight:bold;">REGISTERED NAME</td>
              <td style="font-weight:bold;">DATE</td>
              <td style="font-weight:bold;">ATC</td>
              <td style="font-weight:bold;">AMOUNT</td>
              <td style="font-weight:bold;">TAX RATE</td>
              <td style="font-weight:bold;">TAX W/HELD</td>
            </tr>
