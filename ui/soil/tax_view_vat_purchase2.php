        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                    <h5 class="m-0 text-white" ><a href="tax_vat_purchase.php" class="text-white">View VAT Purchase</a> / View VAT Purchase</h5>
                </div>
                <!-- card body open --> 
...
if (isset($_POST['update_vat_purchase'])) 
{

$vat_purchase_id_hidden = $_POST['vat_purchase_id_hidden'];
...
$update = $pdo->prepare("UPDATE tb_tax_vat_purchase 
...
where id = '$vat_purchase_id_hidden'
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        <li class="list-group-item">
                          ...
                          <input type="hidden" value="<?= $vat_purchase_id ?>" name="vat_purchase_id_hidden" >
            ...
            <div class="row">
                ...
                <div class="card-footer">
                  <div class="text-center">
                      <!-- <button type="submit" class="btn btn-primary btn-md" name="update_vat_purchase">Update Vat purchase</button> -->
                  </div>
                </div>
                <!-- card footer close --> 
