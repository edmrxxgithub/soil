...
$government_sales = $_POST['q3_government_sales_principal'];
$zero_rated_sales = $_POST['q3_zero_rated_sales_principal'];
$exempt_sales = $_POST['q3_exempt_sales_principal'];

$other_expenses = $_POST['q3_other_expense_principal'];
$vat_payment_previous = $_POST['q3_vat_payment_previous_principal'];
$tax_actually_paid_success = $_POST['q3_tax_actual_paid_accessory'];

$cost_of_sales = $_POST['q3_less_cost_of_sales_accessory'];
$tax_income_previous = $_POST['q3_net_taxable_income_previous_quarter_accessory'];
$other_expenses_2 = $_POST['q3_other_expenses_value_principal_2'];

$tax_rate = $_POST['q3_tax_rate_principal'];
$mcit = $_POST['q3_mcit_percent_principal'];
$it_payment_previous = $_POST['q3_it_payment_previous_principal'];
$income_tax_actually_paid_success = $_POST['q3_income_tax_actually_paid_accessory'];
