...
$total_as_is_payment_percent = (($total_as_is_payment * 0.12) / $vatable_sales) * 100;
...
$array['calculated_risk']= number_format($calculated_risk,2);
$array['calculated_risk_percent']= number_format($calculated_risk * 0.12,2);

$array['total_as_is_payment_percent']= number_format($total_as_is_payment * 0.12,2,'.','');
$array['benchmark'] = number_format($total_as_is_payment_percent,2).'%';
