        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline" >
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                  <h5 class="m-0 text-white">View Category</h5>
                </div>
                <div class="card-body">
                  <div class="row">
                    
                    <div class="col-sm-12">
                        <a href="property_add_category.php" class="btn btn-sm btn-primary float-sm-right">Add Category</a>
                    </div>
        
                    <div class="col-md-12 mt-3">
                          <div class="table-responsive-sm">
                            <font face="verdana">
                              <table id="property_category_datatable" class="table table-hover" style="width: 100%">
                                  <thead>
                                      <tr>
                                          <td style="font-weight: bold;" align="center">Id</td>
                                          <td style="font-weight: bold;" align="center">Image</td> 
                                          <td style="font-weight: bold;" align="center">Category name</td> 
                                          <td style="font-weight: bold;" align="center">Item count</td> 
                                          <td style="font-weight: bold;" align="center">Carrying amount</td> 
...
<script>
  $(document).ready(function() 
  {
    ...
    var property_category_datatable = $('#property_category_datatable').DataTable(
    {
      // "order": [[ 0, 'desc' ]],
    ...
    "columnDefs": 
        ...
        "ajax": 
        {
          ...
          url:"property_fetch_category_data.php",
          type:"post"
        }  
