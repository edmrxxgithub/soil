        ...
        <div class="col-md-12">
            ...
            <div class="card card-grey card-outline">
                <div class="card-header" style="background-color:rgba(50,63,81,255);">
                  <h5 class="m-0 text-white">View Purchase Declaration</h5>
                </div>
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-3 col-lg-12">
                      <a href="tax_add_purchase.php" class="btn btn-md btn-primary float-md-right">Add purchase</a>
                    ...
                    <div class="col-md-12 mt-3">
                          <div class="table-responsive-sm">
                            <font face="verdana">
                              <table id="tax_purchase_datatable" class="table table-hover" style="width: 100%">
                                  <thead>
                                      <tr>
                                          <td style="font-weight: bold;" align="center"><font size="2">Id</font></td> 
...
<script>
  $(document).ready(function() 
  {
    ...
    var tax_purchase_datatable = $('#tax_purchase_datatable').DataTable(
    {
      "order": [[ 0, 'desc' ]],
...
function reset_filter()
{
    ...
    tax_purchase_datatable.columns(1).search('').draw();
    tax_purchase_datatable.columns(2).search('').draw();
    tax_purchase_datatable.columns(3).search('').draw();
...
$(document).on('click','#btn_delete_purchase',function()
    {
            ...
            }).then((result) => 
            {
              if (result.isConfirmed) 
              {
                ...
                $.ajax({
                  ...
                  success: function(data) 
                  {
                    // $('#tax_purchase_datatable').DataTable().ajax.reload(null, false);
                    $('#tax_purchase_datatable').DataTable().ajax.reload(null, false);
                  }
                });
...
$(document).on('change','#clientid',function()
{
  ...
  tax_purchase_datatable.columns(1).search(clientid).draw();
...
$(document).on('change','#businessid',function()
{
  ...
  tax_purchase_datatable.columns(2).search(businessid).draw();
...
$(document).on('change','#branchid',function()
{
  ...
  tax_purchase_datatable.columns(3).search(branchid).draw();
