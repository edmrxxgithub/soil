      ...
      <div class="row">
        ...
        <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0" ><a href="viewprofile.php" class="text-primary">View Profile</a> / Edit Profile</h5>
              </div>
            <div class="card-body">
...
<ul class="list-group">
  ...
  <li class="list-group-item"><b>Full name :  </b>&emsp;<input type="text"   class="form-control"  value="<?= $row->name ?>"  name="fullname"    placeholder="Input full name" autocomplete="off"></li>
  <li class="list-group-item"><b>Address :    </b>&emsp;<input type="text"   class="form-control"  value="<?= $row->address ?>"  name="address"     placeholder="Input address" autocomplete="off"></li>
  <li class="list-group-item"><b>Contact No. : </b>&emsp;<input type="text"  class="form-control"  value="<?= $row->contact_num ?>" name="contactnum"  placeholder="Input contact number" autocomplete="off"></li>
...
<div class="card-footer">
    <div class="text-center">
        <button type="submit" class="btn btn-primary btn-md" name="updateprofile">Update Profile</button></div>
    </div>
</div>
